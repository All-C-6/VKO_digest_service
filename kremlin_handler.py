...
include_keywords = {
    ...
    "банка Росси",
    "банку Росси",
    "системообразущим банкам",
    "системообразущие банки",
    "системообразущиъ банков",
    "мошенничес",
    "наличн",
    "легализаци"
...
def parse_single_document_entry(document_entry, kremlin_base_url: str) -> Optional[dict[str, str]]:
    ...
    clean_document_title = drop_unwanted_symbols(document_title.replace(document_date, '').strip()) if document_title else ""
